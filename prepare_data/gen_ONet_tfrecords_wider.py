...
def _get_output_filename(output_dir, name, net):
    ...
    if name == 'landmark':
        return '%s/train_ONet_landmark_wider.tfrecord' % (output_dir)
...
def get_dataset(dir, name, net='PNet'):
    ...
    if name == 'landmark':
        dataset_dir = '../data/imglists_noLM/ONet/landmark_48_aug_wider.txt'
...
if __name__ == '__main__':
    dir = '../data/'
    net = 'no_LM48'
    output_directory = '../data/imglists_noLM/ONet'
    name = 'landmark'
